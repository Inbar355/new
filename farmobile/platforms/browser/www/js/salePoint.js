...
function onSuccess(position) {
	alert("onSuccess");
	var location = firstCoordinate + "-" + secondCoordinate;
	navigator.ln.userSelect(location);
	//window.open('waze://?ll=37.331689,-122.030731&navigate=yes');
	//window.open('http://google.com', '_system');
	
	//window.location = "maps:daddr="+firstCoordinate+","+secondCoordinate;
	//window.launchnavigator.navigate("London, UK");
		/*launchnavigator.navigate(firstCoordinate + "-" + secondCoordinate, {
...
function navigate(){
	...
	/*if (deviceType == "Android"){
		try
		{
			...
			String url = "https://waze.com/ul?ll=" + firstCoordinate + "," + secondCoordinate;
