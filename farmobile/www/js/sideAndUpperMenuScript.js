...
function openNav() {
    ...
    document.getElementById("mySidenav").style.borderLeft = "black";
    document.getElementById("mySidenav").style.borderLeftStyle = "groove";
    document.getElementById("mySidenav").style.borderLeftWidth = "thin";
